...
export const CropYieldChart: React.FC<CropYieldChartProps> = ({ activeStep }) => {
  ...
  return (
    <div ref={containerRef} className="w-full h-full flex flex-col lg:flex-row gap-8 items-center justify-between relative">
      ...
      <div className="w-full lg:w-5/12 max-w-sm flex flex-col justify-between h-[390px] relative overflow-hidden">
        ...
        <div className="w-full h-[220px] flex items-center justify-center my-4 relative">
