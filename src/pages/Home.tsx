...
const SkeletonCard = () => (
  <div className="w-full min-h-[60vh] flex items-center justify-center bg-[#0B1A2E]/30 backdrop-blur-md border border-white/5 animate-pulse rounded-xl my-12">
      ...
      <main>
        ...
        <div className="relative z-10 w-full">
          ...
          <VideoDivider
            ...
            posterSrc="/images/pacific_3d_island_fallback.png"
