...
- **Styling & Design Language**: The application adopts the **The Pacific Canvas** theme as its primary design language. It moves away from sharp, generic "tech" aesthetics towards a highly organic, artistic approach resembling watercolor or ink washes. The palette features deep cyan, warm sand gold, and fading coral red. Narrative cards use the **Elegant Editorial** approach: no hard borders, utilizing soft radial gradient ink washes over a dark canvas. Typography relies on elegant Serifs (Playfair Display) for large numbers and headings, paired with clean Sans-serifs (Inter/Outfit) featuring wide tracking for body copy, evoking a premium museum exhibition feel. D3 charts utilize curated gradients mapping to this warm earthy and aquatic palette to maximize visual storytelling and emotional impact.
